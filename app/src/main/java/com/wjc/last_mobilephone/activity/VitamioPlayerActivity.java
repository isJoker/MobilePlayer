...
import com.wjc.last_mobilephone.view.VitamioVideoView;
...
public class VitamioPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private void showSwitchPlayer() {
        ...
        builder.setTitle("提示");
        builder.setMessage("当前是万能播放器播放，是否切换到系统播放器播放");
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case PROGRESS://跟新进度
                    ...
                    int progress = (int) videoview.getCurrentPosition();//1000,2000,0
